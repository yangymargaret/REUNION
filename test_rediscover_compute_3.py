...
def parse_args():
	...
	parser.add_option("--atac_meta",default="-1",help="file path of the ATAC-seq data of the metacell")
	parser.add_option("--rna_meta",default="-1",help="file path of the RNA-seq data of the metacell")
