...
class _Base2_2_pre1(_Base2_2_1):
	...
	## ====================================================
	# perform peak clustering based on the low-dimensional embeddings
	def test_query_feature_clustering_pre1(self,data=[],feature_query_vec=[],feature_type_vec=[],save_mode=1,verbose=0,select_config={}):
		...
		if flag_clustering_1>0:
			...
			self.test_query_feature_clustering_1(dict_feature=dict_latent_query1,
													feature_type_vec=feature_type_vec_pre1,
													feature_type_vec_2=feature_type_vec_2,
													method_type_vec_group=method_type_vec_group,
													feature_mode=feature_mode_query,
	...
	## ====================================================
	# perform clustering of peak loci based on the low-dimensional embeddings
	def test_query_feature_clustering_1(self,dict_feature=[],feature_type_vec=['gene','peak'],feature_type_vec_2=[],method_type_vec_dimension=['SVD'],method_type_vec_group=['phenograph'],type_id_group=0,n_components=50,metric='euclidean',subsample_ratio=-1,flag_cluster_1=1,flag_cluster_2=0,flag_combine=0,overwrite=False,overwrite_2=False,input_file_path='',save_mode=1,output_file_path='',filename_prefix_save='',filename_save_annot='',verbose=0,select_config={}):
		...
		if flag_query_1>0:
			...
			feature_type_annot = ['peak-motif sequence feature']*2+['accessibility feature']*2
			feature_type_vec_pre1 = ['peak_motif','peak_motif_ori','peak_tf','peak_mtx']
			...
			self.dict_feature_type_annot1 = dict_feature_type_annot1
			self.dict_feature_type_annot2 = dict_feature_type_annot2
			...
			for type_id_query in type_vec_group_2:
				...
				if verbose_internal==2:
					annot_str1 = dict_feature_type_annot2[field_id2]
					print('feature embeddings of peak loci, dataframe of size ',df_latent_1.shape, ' %s'%(annot_str1))
					print('preview:\n',df_latent_1[0:2])

				# perform group estimation
				self.test_query_association_group_1(data=dict_query_1,feature_type_query=feature_type_query,
															dict_feature=[],
															feature_type_vec=feature_type_vec,
															method_type=method_type_query,
															field_query=field_query,
															peak_read=peak_read,rna_exprs=rna_exprs,
															flag_cluster_query_1=flag_cluster_query_1,
															flag_cluster_query_2=flag_cluster_query_2,
															n_components=n_components,
															iter_id=iter_id,config_id_load=config_id_load,
															overwrite=overwrite_2,
															input_file_path=input_file_path,
															save_mode=save_mode,output_file_path=output_file_path_2,output_filename='',filename_prefix_save=filename_prefix_save,filename_save_annot=filename_save_annot_2,
															verbose=verbose,select_config=select_config)

	## ====================================================
	# perform group estimation of peak loci
	def test_query_association_group_1(self,data=[],feature_type_query='',dict_feature=[],feature_type_vec=[],method_type='',field_query=[],peak_read=[],rna_exprs=[],flag_cluster_query_1=1,flag_cluster_query_2=0,n_components=50,iter_id=-1,config_id_load=-1,overwrite=True,input_file_path='',
		...
		if flag_cluster_query_1>0:
			...
			if flag_config1>0:
				...
				list_config = test_estimator_group.test_cluster_query_config_1(method_type_vec=method_type_vec_1,
			...
			test_estimator_group.test_query_group_1(data=feature_mtx_query,adata=[],feature_type_query=feature_type_query,list_config=list_config,flag_iter_2=flag_iter_2,flag_clustering_1=flag_clustering_1,
		...
		if flag_cluster_query_2>0:
			...
			if flag_config2>0:
				...
				distance_threshold_pre, linkage_type_id_pre, neighbors_pre, n_clusters_pre = -1, 0, 20, 100
				list_config2 = test_estimator_group.test_cluster_query_config_1(method_type_vec=method_type_vec_1,
																			distance_threshold=distance_threshold_pre,
																			linkage_type_id=linkage_type_id_pre,
																			neighbors=neighbors_pre,
																			n_clusters=n_clusters_pre,
	...
	## ====================================================
	# load feature group estimation of peak loci
	# query the estimated group labels of peak loci
	...
	def test_query_feature_group_load_1(self,data=[],feature_type_vec=[],feature_query_vec=[],method_type_group='',input_file_path='',save_mode=1,output_file_path='',filename_prefix_save='',filename_save_annot='',output_filename='',verbose=0,select_config={}):
		...
		if flag_query1>0:
			...
			for feature_type_query in feature_type_vec_query:
				b1 = feature_type_query.find('peak_mtx')
				b2 = feature_type_query.find('peak_tf')
				b3 = feature_type_query.find('peak_motif')
				if (b1>=0) or (b2>=0):
					annot_str = 'peak accessibility feature'
				else:
					annot_str1 = 'peak-motif feature'
	...
	def test_query_enrichment_pre1(self,df1,df2,column_query='',stat_chi2_correction=True,stat_fisher_alternative='greater',save_mode=1,verbose=0,select_config={}):
		...
		"""
		query query feature enrichment
		:param df1:
		:param df2:
		:return: 
		"""
	...
	## ====================================================
	# query enrichment of peaks in the groups in the specific feature space
	def test_query_group_overlap_pre1_1(self,df_group_1=[],df_group_2=[],df_overlap_1=[],df_query_compare=[],feature_query_vec=[],column_query='',flag_shuffle=0,stat_chi2_correction=True,stat_fisher_alternative='greater',save_mode=1,output_file_path='',output_filename='',verbose=0,select_config={}):
		...
		"""
		query enrichment of peaks with TF binding predicted in the groups in the feature space
		:param df_group_1:
		:param df_group_2:
		:return: 
		"""
	...
	## ====================================================
	# query enrichment of peaks in the paired groups
	def test_query_group_overlap_pre1_2(self,data=[],dict_group_compare=[],df_group_1=[],df_group_2=[],df_overlap_1=[],df_query_compare=[],column_sort=[],flag_sort=1,flag_sort_2=1,flag_group=1,flag_annot=1,stat_chi2_correction=True,stat_fisher_alternative='greater',save_mode=1,output_file_path='',output_filename='',output_filename_2='',filename_prefix_save='',filename_save_annot='',verbose=0,select_config={}):
		...
		if flag_query1>0:
			...
			if verbose_internal==2:
				...
				print('group assignment of peak loci using feature type 1, dataframe of size ',df_group_1.shape)
				print('data preview: ')
				print(df_group_1[0:2])
				print('group assignment of peak loci using feature type 2, dataframe of size ',df_group_2.shape)
				print('data preview: ')
				print(df_group_2[0:2])

				# print('df_group_query1, df_group_query2: ',df_group_query1.shape,df_group_query2.shape)
				print('group assignment of candidate peak loci using feature type 1, dataframe of size ',df_group_query1.shape)
				print('group assignment of candidate peak loci using feature type 2, dataframe of size ',df_group_query2.shape)
	...
	# query enrichment of peaks with the TF motif detected in the paired groups
	...
	# query enrichment of peaks with TF binding predicted in the paired groups
	...
	## ====================================================
	# query neighbors of samples in the feature space
	def test_query_feature_neighbor_pre1(self,data=[],n_neighbors=20,return_distance=True,save_mode=1,verbose=0,select_config={}):
		...
		# query neighbors of the observations in the feature space
		...
		if flag_neighbor_query>0:
			...
			if load_mode_pre2>0:
				...
				for i2 in range(query_num):
					...
					if os.path.exists(input_filename_1)==True:
						...
						print('data loaded from %s'%(input_filename_1))
					...
					if os.path.exists(input_filename_2)==True:
						...
						print('data loaded from %s'%(input_filename_2))
			...
			if load_mode_pre2>0:
				...
				for i1 in range(feature_type_num):
					...
					print('neighbor number: %d'%(n_neighbors_query))
					start = time.time()
					...
					print('feature matrix for %s, dataframe of size '%(feature_type_query),df_feature_1.shape)
					subsample_num = -1
					if subsample_num>0:
						df_feature_1 = df_feature_1[0:subsample_num]
						print('df_feature_1 sub_sample: ',df_feature_1.shape)
					feature_nbrs_1, dist_nbrs_1 = self.test_query_feature_neighbor_pre1(data=df_feature_1,n_neighbors=n_neighbors_query,return_distance=True,save_mode=1,verbose=0,select_config=select_config)
	...
	def test_query_feature_embedding_pre1(self,data=[],dict_feature=[],feature_type_vec=[],method_type='',
		...
		:param method_type_dimension: the method for dimension reduction
		:param n_components: the number of latent components used for feature representation
		:param select_config: dictionary storing other parameters
		:return: dict_query1: {feature_type:latent score matrix (feature embedding), feature_type:component matrix}
		"""
		...
		# dict_query1: {feature_type:latent score matrix, feature_type:component matrix}
	...
	def test_query_feature_embedding_load_pre1(self,data=[],dict_file={},method_type_vec=[],feature_type_vec=[],method_type_dimension='SVD',n_components=100,n_component_sel=50,peak_read=[],rna_exprs=[],reconstruct=1,load_mode=0,input_file_path='',save_mode=0,output_file_path='',output_filename='',filename_prefix_save='',filename_save_annot='',verbose=0,select_config={}):
		...
		"""
		compute feature embeddings of peak loci
		:param n_component_sel: the number of latent components used for feature representation
		:return: dict_query1: {feature_type: {df_latent(feature embedding), df_component(component matrix), reconstruct_mtx}}
		:select_config: dictionary storing other parameters
		"""
	...
	## ====================================================
	# load low-dimensional embeddings of peak loci
	def test_query_feature_embedding_load_1(self,data=[],dict_file={},feature_query_vec=[],motif_id_query='',motif_id='',feature_type_vec=[],feature_type_vec_group=[],method_type_vec=[],method_type_dimension='SVD',n_components=50,n_component_sel=50,reconstruct=1,peak_read=[],rna_exprs=[],flag_combine=1,load_mode=0,input_file_path='',save_mode=1,output_file_path='',output_filename='',filename_prefix_save='',filename_save_annot='',verbose=0,select_config={}):
		...
		"""
		compute feature embeddings of peak loci
		parameters are stored in select_config
		param n_component_sel: the number of latent components used for feature representation
		return: dict_query1: {feature_type:latent score matrix (feature embedding)}
		"""
		...
		if flag_query1>0:
			...
			for i1 in range(feature_type_num):
				...
				df_query = dict_query_1[feature_type_query]['df_latent'] # load the latent score matrix
	...
	def test_query_binding_clustering_1(self,data1=[],data2=[],dict_group=[],dict_neighbor=[],dict_group_basic_1=[],df_overlap_1=[],df_overlap_compare=[],group_type_vec=['group1','group2'],feature_type_vec=[],group_vec_query=[],input_file_path='',save_mode=1,output_file_path='',output_filename='',filename_prefix_save='',filename_save_annot='',verbose=0,select_config={}):
		...
		if type_query_group==0:
			...
			df_pre1 = self.test_query_feature_group_neighbor_pre1_unit1(data=df_pre1,dict_group=dict_group,dict_neighbor=dict_neighbor,
																			group_type_vec=group_type_vec,feature_type_vec=feature_type_vec,
	...
	def test_query_feature_group_neighbor_pre1(self,data=[],dict_group=[],dict_neighbor=[],group_type_vec=['group1','group2'],feature_type_vec=[],group_vec_query=[],column_vec_query=[],n_neighbors=30,input_file_path='',save_mode=0,output_file_path='',output_filename='',filename_prefix_save='',filename_save_annot='',verbose=0,select_config={})
		...
		if (flag_neighbor_2>0):
			...
			df_pre1 = self.test_query_feature_neighbor_pre1_2(data=df_pre1,column_query=column_pred2,list_feature=list_feature,
																	column_neighbor=column_neighbor,column_vec_query=column_vec_query,verbose=verbose,select_config=select_config)
	...
	# feature group query and feature neighbor query
	# TF binding prediction by feature group query and feature neighbor query
	def test_query_feature_group_neighbor_pre1_unit1(self,data=[],dict_group=[],dict_neighbor=[],group_type_vec=['group1','group2'],feature_type_vec=[],group_vec_query=[],column_vec_query=[],n_neighbors=30,parallel=0,input_file_path='',save_mode=0,output_file_path='',output_filename='',filename_prefix_save='',filename_save_annot='',verbose=0,select_config={}):
				...
				if parallel==0:
					for group_id_2 in group_vec_2_query:
						...
						if flag_neighbor_pre2>0:
							...
							# stop = time.time()
							# print('query neighbors of peak loci in the paired group',group_id_1,group_id_2,stop-start)
	...
	## ====================================================
	# query neighbors of feature query
	def test_query_feature_neighbor_pre1_2(self,data=[],column_query='',list_feature=[],column_neighbor='',column_vec_query=[],verbose=0,select_config={}):
	...
	def test_query_compare_peak_tf_corr_1(self,data=[],motif_id_query='',motif_id1='',motif_id2='',column_signal='signal',column_value='',thresh_value=-0.05,motif_data=[],motif_data_score=[],peak_read=[],rna_exprs=[],flag_query=0,input_file_path='',save_mode=1,output_file_path='',filename_prefix_save='',filename_save_annot='',output_filename='',verbose=0,select_config={}):
		...
		if flag_query1>0:
			...
			if flag_peak_tf_corr>0:
				...
				if verbose_internal==2:
					print('peak accessibility-TF expression correlation, dataframe of size ',peak_tf_corr_1.shape)
					print(peak_tf_corr_1[0:2])

					print('p-value corrected, dataframe of size ',peak_tf_pval_corrected1.shape)
	...
	def test_query_gene_annot_1(self,input_filename='',save_mode=1,verbose=0,select_config={}):
	...
	def test_query_compare_binding_compute_2(self,data=[],dict_feature=[],feature_type_vec=[],method_type_vec=[],method_type_dimension='SVD',n_components=50,peak_read=[],rna_exprs=[],flag_score_1=0,flag_score_2=0,flag_compare_1=0,load_mode=0,input_file_path='',save_mode=1,output_file_path='',output_filename='',filename_prefix_save='',filename_save_annot='',verbose=0,select_config={}):
		...
		if flag_query2>0:
			...
			print('method for initial peak-TF assocation estimation: %s'%(method_type_query))
